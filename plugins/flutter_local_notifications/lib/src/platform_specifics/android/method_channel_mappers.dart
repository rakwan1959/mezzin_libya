...
extension AndroidNotificationDetailsMapper on AndroidNotificationDetails {
  Map<String, Object?> toMap() =>
      <String, Object?>{
          ...
          'customBigLayout': customBigLayout,
          'customLayoutIcon': customLayoutIcon,
          'customLayoutBadge': customLayoutBadge,
          'customLayoutFooter': customLayoutFooter,
          'customLayoutAccentAlpha': customLayoutAccent?.intAlpha,
          'customLayoutAccentRed': customLayoutAccent?.intRed,
          'customLayoutAccentGreen': customLayoutAccent?.intGreen,
          'customLayoutAccentBlue': customLayoutAccent?.intBlue,
          'number': number,
          'audioAttributesUsage': audioAttributesUsage.value,
